...
const SEND_INSTANCES: SendInstance[] = [
  ...
  { baseUrl: 'https://send.turingpoint.de', label: 'send.turingpoint.de', region: 'eu', country: 'DE', maxBytes: 10 * 1024 * 1024 * 1024, maxExpireSeconds: 604800, maxDownloads: 100 },
  ...
  { baseUrl: 'https://send.mni.li', label: 'send.mni.li', region: 'eu', country: 'NL', maxBytes: 8 * 1024 * 1024 * 1024, maxExpireSeconds: 604800, maxDownloads: 100 },
  ...
  { baseUrl: 'https://send.vis.ee', label: 'send.vis.ee', region: 'eu', country: 'NL', maxBytes: 2684354560, maxExpireSeconds: 259200, maxDownloads: 100 },
  ...
  { baseUrl: 'https://send.monks.tools', label: 'send.monks.tools', region: 'other', country: 'US', maxBytes: 5 * 1024 * 1024 * 1024, maxExpireSeconds: 604800, maxDownloads: 100 },

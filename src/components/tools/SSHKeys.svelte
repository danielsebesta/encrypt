...
<div class="space-y-6 animate-in fade-in duration-500">
  <div class="grid gap-6">
    <div class="grid gap-1.5">
      <label class="text-xs text-zinc-500 font-bold uppercase tracking-wider">Key Type</label>
    ...
    >
      {isGenerating ? 'Generating SSH Keys...' : 'Generate SSH Key Pair'}
    </button>
      ...
      <div class="space-y-6 animate-in slide-in-from-bottom-2">
        ...
        <div class="space-y-2">
          <div class="flex justify-between items-end">
            ...
            >
              Private Key (OpenSSH - STORE SECURELY)
            </label>
            <button
              type="button"

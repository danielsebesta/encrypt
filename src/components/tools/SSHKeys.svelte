<script lang="ts">
  import { generateSSHKeyPair } from '../../lib/rsaKeys';
  import { t } from '../../lib/t';
...
<div class="space-y-6 animate-in fade-in duration-500">
  <div class="grid gap-6">
    ...
    <div class="grid gap-1.5">
      <label class="label">{t(dict, 'tools.sshKeys.keyBitLength')}</label>
    ...
    {#if keyPair}
      <div class="space-y-6 animate-in slide-in-from-bottom-2">
        <div class="space-y-2">
          ...
          <pre
            class="result-box-neutral text-[10px] max-h-40 whitespace-pre-wrap select-all"

  ...
  <div class="grid gap-6">
    <div class="grid grid-cols-2 gap-4">
        <div class="grid gap-1.5">
            <label class="text-xs text-zinc-500 font-bold uppercase tracking-wider">Entropy Length</label>
            <input type="number" bind:value={length} on:input={refresh} min="8" max="128" class="input" />
        </div>
        <div class="grid gap-1.5">
            <label class="text-xs text-zinc-500 font-bold uppercase tracking-wider">Encoding</label>
    ...
    <div class="grid gap-2">
      <div class="flex justify-between items-end">
        <label class="text-xs text-zinc-500 font-bold uppercase tracking-wider">Generated Token</label>
    ...
    <button on:click={refresh} class="btn-secondary w-full py-4 uppercase tracking-widest text-xs font-black">Refresh Token</button>
  </div>
</div>

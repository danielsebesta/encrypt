...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    <div class="space-y-4">
      ...
      >
        {#if encodedImageUrl}
          <img src={encodedImageUrl} alt={t(dict, 'tools.photoCipher.encodedAlt')} class="max-h-full max-w-full object-contain" />
        {:else if imageUrl}
          <img src={imageUrl} alt={t(dict, 'tools.photoCipher.previewAlt')} class="max-h-full max-w-full object-contain" />
        {:else}
          <div class="space-y-2">

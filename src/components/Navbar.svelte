  ...
  <div class="max-w-7xl mx-auto px-5 flex items-center justify-between h-16">
    ...
    <div class="hidden md:flex items-center gap-2">
      ...
      <div class="flex items-center gap-0.5">
          <a href="https://github.com/danielsebesta/encrypt.click" target="_blank" rel="noopener noreferrer" class="btn-ghost btn-icon rounded-full p-2.5 hover:bg-zinc-100 dark:hover:bg-zinc-800" aria-label="GitHub">

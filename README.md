...
- Every user-facing UI string belongs in [`src/locales/en.json`](src/locales/en.json), [`src/locales/cs.json`](src/locales/cs.json), and [`src/locales/de.json`](src/locales/de.json).
